...
<head>
    ...
    <title>Expense Management API API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-GETapi-user">Get the authenticated user.</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="user-management">
                    <a href="#user-management">User Management</a>
                                ...
                                <a href="#user-management-GETapi-users">Display a listing of the users.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-POSTapi-users">
                                <a href="#user-management-POSTapi-users">Store a newly created user in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-GETapi-users--id-">
                                <a href="#user-management-GETapi-users--id-">Display the specified user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-PUTapi-users--id-">
                                <a href="#user-management-PUTapi-users--id-">Update the specified user in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-DELETEapi-users--id-">
                                <a href="#user-management-DELETEapi-users--id-">Remove the specified user from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="expense-management">
                    <a href="#expense-management">Expense Management</a>
                                    ...
                                    <ul id="tocify-subheader-expense-management" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="expense-management-GETapi-expenses">
                                <a href="#expense-management-GETapi-expenses">Display a listing of expenses with pagination and search.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expense-management-POSTapi-expenses">
                                <a href="#expense-management-POSTapi-expenses">Store a newly created expense in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expense-management-GETapi-expenses--id-">
                                <a href="#expense-management-GETapi-expenses--id-">Display the specified expense.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expense-management-PUTapi-expenses--id-">
                                <a href="#expense-management-PUTapi-expenses--id-">Update the specified expense in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expense-management-DELETEapi-expenses--id-">
                                <a href="#expense-management-DELETEapi-expenses--id-">Remove the specified expense from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="audit-logs">
                    <a href="#audit-logs">Audit Logs</a>
                                    ...
                                    <ul id="tocify-subheader-audit-logs" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="audit-logs-GETapi-audit-logs">
                                <a href="#audit-logs-GETapi-audit-logs">Display a listing of audit logs.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="audit-logs-GETapi-audit-logs--id-">
                                <a href="#audit-logs-GETapi-audit-logs--id-">Display the specified audit log.</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-performance-testing" class="tocify-header">
                <li class="tocify-item level-1" data-unique="performance-testing">
                    <a href="#performance-testing">Performance Testing</a>
                </li>
                                    <ul id="tocify-subheader-performance-testing" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="performance-testing-GETapi-eager-loading-test">
                                <a href="#performance-testing-GETapi-eager-loading-test">Run tests to demonstrate eager loading benefits</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-test-eager-loading">
                                <a href="#endpoints-GETapi-test-eager-loading">GET api/test-eager-loading</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the user. Must not be greater than 255 characters. Example: <code>b</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The email of the user. Must be a valid email address. Must not be greater than 255 characters. Example: <code>zbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The password for the user. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company_name"                data-endpoint="POSTapi-register"
               value="n"
               data-component="body">
    <br>
<p>The name of the company. Must not be greater than 255 characters. Example: <code>n</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company_email"                data-endpoint="POSTapi-register"
               value="ashly64@example.com"
               data-component="body">
    <br>
<p>The email of the company. Must be a valid email address. Must not be greater than 255 characters. Example: <code>ashly64@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The password confirmation. Must match password. Example: <code>architecto</code></p>
        </div>
        </form>
...
<p>Example: <code>|]|{+-</code></p>
                    ...
                    <h2 id="authentication-GETapi-user">Get the authenticated user.</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="user-management">User Management</h1>
                                ...
                                <h2 id="user-management-GETapi-users">Display a listing of the users.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-management-POSTapi-users">Store a newly created user in storage.</h2>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>Admin</code></li> <li><code>Manager</code></li> <li><code>Employee</code></li></ul>
        </div>
        </form>

                    <h2 id="user-management-GETapi-users--id-">Display the specified user.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/users/63" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/users/63"
);
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the user. Example: <code>63</code></p>
            </div>
                    </form>

                    <h2 id="user-management-PUTapi-users--id-">Update the specified user in storage.</h2>
...
<ul style="list-style-type: square;"><li><code>Admin</code></li> <li><code>Manager</code></li> <li><code>Employee</code></li></ul>
                    ...
                    <h2 id="user-management-DELETEapi-users--id-">Remove the specified user from storage.</h2>
...
<p>The ID of the user. Example: <code>63</code></p>
                ...
                <h1 id="expense-management">Expense Management</h1>
                                ...
                                <h2 id="expense-management-GETapi-expenses">Display a listing of expenses with pagination and search.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="expense-management-POSTapi-expenses">Store a newly created expense in storage.</h2>
...
<p>Must not be greater than 100 characters. Example: <code>g</code></p>
                    ...
                    <h2 id="expense-management-GETapi-expenses--id-">Display the specified expense.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/expenses/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/expenses/16"
);
...
<p>The ID of the expense. Example: <code>16</code></p>
                    ...
                    <h2 id="expense-management-PUTapi-expenses--id-">Update the specified expense in storage.</h2>
...
<p>Must not be greater than 100 characters. Example: <code>g</code></p>
                    ...
                    <h2 id="expense-management-DELETEapi-expenses--id-">Remove the specified expense from storage.</h2>
...
<p>The ID of the expense. Example: <code>16</code></p>
                ...
                <h1 id="audit-logs">Audit Logs</h1>
                                ...
                                <h2 id="audit-logs-GETapi-audit-logs">Display a listing of audit logs.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="audit-logs-GETapi-audit-logs--id-">Display the specified audit log.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/audit-logs/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/audit-logs/architecto"
);
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-audit-logs--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the audit log. Example: <code>architecto</code></p>
                ...
                <h1 id="performance-testing">Performance Testing</h1>
                                ...
                                <h2 id="performance-testing-GETapi-eager-loading-test">Run tests to demonstrate eager loading benefits</h2>
...
<span id="example-requests-GETapi-eager-loading-test">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/eager-loading-test" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/eager-loading-test"
);
...
<span id="example-responses-GETapi-eager-loading-test">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-eager-loading-test" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-eager-loading-test"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-eager-loading-test"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-eager-loading-test" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-eager-loading-test">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-eager-loading-test" data-method="GET"
      data-path="api/eager-loading-test"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-eager-loading-test', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-eager-loading-test"
                    onclick="tryItOut('GETapi-eager-loading-test');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-eager-loading-test"
                    onclick="cancelTryOut('GETapi-eager-loading-test');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-eager-loading-test"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/eager-loading-test</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-eager-loading-test"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-eager-loading-test"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-test-eager-loading">GET api/test-eager-loading</h2>
...
<span id="example-requests-GETapi-test-eager-loading">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/test-eager-loading" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/test-eager-loading"
);
...
<span id="example-responses-GETapi-test-eager-loading">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-test-eager-loading" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-test-eager-loading"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-test-eager-loading"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-test-eager-loading" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-test-eager-loading">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-test-eager-loading" data-method="GET"
      data-path="api/test-eager-loading"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-test-eager-loading', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-test-eager-loading"
                    onclick="tryItOut('GETapi-test-eager-loading');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-test-eager-loading"
                    onclick="cancelTryOut('GETapi-test-eager-loading');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-test-eager-loading"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/test-eager-loading</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-test-eager-loading"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-test-eager-loading"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
