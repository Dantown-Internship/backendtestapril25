                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                @foreach ($collection as $expense)
                                                    <td
                                                        style="padding: 0 0 16px; font-size: 14px; line-height: 150%; color: #000000;">
                                                        <span style="font-weight: bold;">{{ $expense->title }}</span>
                                                        <br />
                                                        <span style="color: #8B949F;">{{ $expense->amount }}</span>
                                                    </td>)
                            ...
                            <tr>
                                <td style="padding: 24px 0 48px; font-size: 0px;">
                                    ...
                                    <div class="outlook-group-fix"
                                        ...
                                        <span
                                            style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">Expense
                                            Report<br /></span>
                                    </div>
