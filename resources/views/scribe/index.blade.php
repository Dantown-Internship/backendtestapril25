    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="expenses">
                    <a href="#expenses">Expenses</a>
                                ...
                                <a href="#expenses-GETapi-expenses">List all products</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-POSTapi-expenses">
                                <a href="#expenses-POSTapi-expenses">Create New Expense</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-PUTapi-expenses--id-">
                                <a href="#expenses-PUTapi-expenses--id-">Updates Single Expense</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-DELETEapi-expenses--id-">
                                <a href="#expenses-DELETEapi-expenses--id-">Updates Single Expense</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user">
                    <a href="#user">User</a>
                                ...
                                <a href="#user-GETapi-users">List all users</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-POSTapi-users">
                                <a href="#user-POSTapi-users">Create New User</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-PUTapi-users--id-">
                                <a href="#user-PUTapi-users--id-">Updates Single User</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>API Documentation for Multi Tenant SAAS Platform</p>
<aside>
...
<p>You can retrieve your token by first registering on the Register route to create a user and retrieve your token, But if you already have a user account, then use the login route to retrieve a token</p>

        <h1 id="authentication">Authentication</h1>

    <p>Auth Related Apis</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's full name. Max 255 characters. Example: <code>John Doe</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's email address. Max 255 characters. Must be unique. Example: <code>john@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters and confirmed. Example: <code>secret123</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company.name"                data-endpoint="POSTapi-register"
               value="Acme Corporation"
               data-component="body">
    <br>
<p>Company name, at least 8 characters. Example: <code>Acme Corporation</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company.email"                data-endpoint="POSTapi-register"
               value="contact@acme.com"
               data-component="body">
    <br>
<p>Company contact email address. Example: <code>contact@acme.com</code></p>
                    </div>
                                    </details>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's email address. Must be a valid email. Max 255 characters. Example: <code>user@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>This endpoint logs out a user</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Expense Related Apis</p>

                                <h2 id="expenses-GETapi-expenses">List all products</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint returns a paginated list of all expenses</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: [
        {
            &quot;id&quot;: 29,
            &quot;title&quot;: &quot;id totam temporibus&quot;,
            &quot;category&quot;: &quot;quia&quot;,
            &quot;amount&quot;: 31751.93
        },
        {
            &quot;id&quot;: 30,
            &quot;title&quot;: &quot;non quia dicta&quot;,
            &quot;category&quot;: &quot;in&quot;,
            &quot;amount&quot;: 97532.64
        }
    ],
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="expenses-POSTapi-expenses">Create New Expense</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint creates a new expense</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The title or description of the expense. Max 255 characters. Example: <code>Office Supplies</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The category of the expense. Max 100 characters. Example: <code>Equipment</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The amount spent. Must be zero or greater. Example: <code>149.99</code></p>
        </div>
        </form>

                    <h2 id="expenses-PUTapi-expenses--id-">Updates Single Expense</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint updates a single expense</p>
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/expenses/17" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<code class="language-json" style="max-height: 300px;">{ &quot;data&quot;: {&quot;message&quot;: &quot;App\Models\Expense not found&quot;}}</code>
 </pre>
    </span>
...
<p>The amount spent. Must be zero or greater. Example: <code>149.99</code></p>
                    ...
                    <h2 id="expenses-DELETEapi-expenses--id-">Updates Single Expense</h2>
...
<p>The ID of the expense. Example: <code>17</code></p>
    ...
    <p>User Related Apis</p>

                                <h2 id="user-GETapi-users">List all users</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint returns a paginated list of all users</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-POSTapi-users">Create New User</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's full name. Max 255 characters. Example: <code>Jane Doe</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's email address. Must be unique and valid. Max 255 characters. Example: <code>jane@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional The user role. Must be one of: manager, employee, admin. Example: <code>manager</code></p>
        </div>
        </form>

                    <h2 id="user-PUTapi-users--id-">Updates Single User</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>This endpoint updates a single user</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        &quot;id&quot;: 62,
        &quot;name&quot;: &quot;Damien Murazik&quot;,
        &quot;email&quot;: &quot;wunsch.eldon@example.com&quot;,
        &quot;role&quot;: &quot;employee&quot;
    }
}</code>
 </pre>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the user. Example: <code>21</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
