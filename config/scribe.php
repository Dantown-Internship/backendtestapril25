...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by first registering on the Register route to create a user and retrieve your token, But if you already have a user account, then use the login route to retrieve a token',
    ],
